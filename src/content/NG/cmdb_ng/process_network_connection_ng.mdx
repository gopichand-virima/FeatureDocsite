...
description: "The Process Network Connections action identifies and updates network connectivity details for selected Configuration Items (CIs)."
version: ""
module: "CMDB"
section: "Process Network Connection"
page: "Process Network Connections"
breadcrumbs:
  - "Home"
  - ""
  - "CMDB"
