...
description: "The Process Network Virtualization Hierarchy action organizes and updates the hierarchical structure of VMware vCenter resources"
version: ""
module: "CMDB"
section: "Proces Network Virtualization Hierarchy"
page: "Process Network Virtualization Hierarchy"
breadcrumbs:
  - "Home"
  - ""
  - "CMDB"
