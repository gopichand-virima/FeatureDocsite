...
description: "This file stores the credentials (which are encrypted) and is used by the application to scan the assets. These credentials are entered manually through one of the following ways:"
version: ""
module: "Admin Discovery"
section: "Credentials Backup File"
page: "Credentials Backup File"
breadcrumbs:
  - "Home"
  - ""
  - "Admin Discovery"
