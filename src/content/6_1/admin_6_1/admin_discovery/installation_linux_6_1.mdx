...
description: "The Linux Application can perform&#160;Unix System Discovery&#160;and&#160;Network Device Discovery&#160;in a Network."
version: ""
module: "Admin Discovery"
section: "Installation Linux"
page: "Installing and Running the Linux Application"
breadcrumbs:
  - "Home"
  - ""
  - "Admin Discovery"
...
To start the service, from the main window, select **[**Admin > Client**](/admin_discovery/client_6_1.mdx)**.
