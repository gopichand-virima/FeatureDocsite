...
Refer to [CI - Relationships](/itsm/config_mngmt/config_items/config_item_details/config_items_relationships_ng.mdx) and [Blueprints](/admin_sacm/blueprints_ng.mdx) for details on using this information.
