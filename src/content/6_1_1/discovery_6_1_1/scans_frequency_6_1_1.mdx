...
- Manage any [Tasks](/itsm/release_mngmt/tasks_6_1_1.mdx), [Comments](/discovery/comments_6_1_1.mdx), or [Attachments](/discovery/attachments_6_1_1.mdx).
...
![scan frequency example](../Resources/Images/Discovery/scan-frequency-example.PNG)

![scan frequency new](../Resources/Images/Discovery/scan-frequency-new.PNG) |
...
- [Background Scan Information](/discovery/scans_background_info_6_1_1.mdx)
- [Scheduled Scans](/discovery/scans_scheduled_6_1_1.mdx)
- [Run a Scan](/discovery/run_a_scan/run_a_scan_6_1_1.mdx)
- [Recent Scans](/discovery/recent_scans/scans_recent_6_1_1.mdx)
