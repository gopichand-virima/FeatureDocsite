...
Use this function to create view and modify Ad Hoc reports and save [Canned Reports](/reports/reports_canned_5_13.mdx).

There are three steps in the process:

Step 1. Specify the **Identifying Information** such as visibility and frequency. *See below*.

Step 2. Select the **Report Properties** and set the **Conditions**. *Refer to* [Report Properties and Conditions](/reports/reports_props_conds_5_13.mdx)*.*

Step 3. **Run** (or Generate) the report. *Refer to* [Run Report](/reports/reports_run_5_13.mdx)*.*
...
To continue the process, follow the instructions for [Report Properties and Conditions](/reports/reports_props_conds_5_13.mdx).
