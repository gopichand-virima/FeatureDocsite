...
function registerAdminChangeManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/about_change_mngmnt_6_1.mdx', createDocContent(
    'About Change Management Admin',
    'Admin - Change Management',
    'Configure change management settings and workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/add_change_model_6_1.mdx', createDocContent(
    'Add Change Model',
    'Admin - Change Management',
    'Create new change models for standardized processes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/add_changes_6_1.mdx', createDocContent(
    'Add Changes',
    'Admin - Change Management',
    'Add new change types and categories.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_category_6_1.mdx', createDocContent(
    'Change Category',
    'Admin - Change Management',
    'Define change categories for classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_ci_category_6_1.mdx', createDocContent(
    'Change CI Category',
    'Admin - Change Management',
    'Configure CI categories affected by changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_closure_code_6_1.mdx', createDocContent(
    'Change Closure Code',
    'Admin - Change Management',
    'Define closure codes for completed changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_error_code_6_1.mdx', createDocContent(
    'Change Error Code',
    'Admin - Change Management',
    'Configure error codes for failed or problematic changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_model_6_1.mdx', createDocContent(
    'Change Model',
    'Admin - Change Management',
    'Manage pre-defined change models and templates.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_priority_calculator_6_1.mdx', createDocContent(
    'Change Priority Calculator',
    'Admin - Change Management',
    'Configure automatic priority calculation for changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_risk_assesments_6_1.mdx', createDocContent(
    'Change Risk Assessments',
    'Admin - Change Management',
    'Configure risk assessment criteria for changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_risk_assessments_6_1.mdx', createDocContent(
    'Change Risk Assessments',
    'Admin - Change Management',
    'Define risk assessment parameters and thresholds.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_risks_6_1.mdx', createDocContent(
    'Change Risks',
    'Admin - Change Management',
    'Identify and manage risks associated with changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_stage_state_6_1.mdx', createDocContent(
    'Change Stage State',
    'Admin - Change Management',
    'Configure change stages and states.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_state_workflow_6_1.mdx', createDocContent(
    'Change State Workflow',
    'Admin - Change Management',
    'Define state transition workflows for changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_timescale_6_1.mdx', createDocContent(
    'Change Timescale',
    'Admin - Change Management',
    'Configure timescale settings for change processes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/change_types_6_1.mdx', createDocContent(
    'Change Types',
    'Admin - Change Management',
    'Define and manage different types of changes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/changes_6_1.mdx', createDocContent(
    'Changes Admin',
    'Admin - Change Management',
    'Overall change management configuration.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/request_changes_6_1.mdx', createDocContent(
    'Request Changes Admin',
    'Admin - Change Management',
    'Configure change request settings and approval workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_change_mngmnt/risk_assessments_6_1.mdx', createDocContent(
    'Risk Assessments',
    'Admin - Change Management',
...
function registerAdminIncidentManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/about_incident_mngmnt_6_1.mdx', createDocContent(
    'About Incident Management Admin',
    'Admin - Incident Management',
    'Configure incident management settings and workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_auto_escalation_6_1.mdx', createDocContent(
    'Incident Auto Escalation',
    'Admin - Incident Management',
    'Configure automatic incident escalation rules.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_category_6_1.mdx', createDocContent(
    'Incident Category',
    'Admin - Incident Management',
    'Define incident categories for classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_error_code_6_1.mdx', createDocContent(
    'Incident Error Code',
    'Admin - Incident Management',
    'Configure error codes for incidents.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_model_6_1.mdx', createDocContent(
    'Incident Model',
    'Admin - Incident Management',
    'Create incident models for recurring issues.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_priority_calculator_6_1.mdx', createDocContent(
    'Incident Priority Calculator',
    'Admin - Incident Management',
    'Configure automatic priority calculation based on impact and urgency.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_states_substates_6_1.mdx', createDocContent(
    'Incident States & Substates',
    'Admin - Incident Management',
    'Define incident states and substates for workflow management.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_incident_mngmnt/incident_timescale_6_1.mdx', createDocContent(
    'Incident Timescale',
    'Admin - Incident Management',
...
function registerAdminProblemManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_problem_mngmnt/about_problem_mngmnt_6_1.mdx', createDocContent(
    'About Problem Management Admin',
    'Admin - Problem Management',
    'Configure problem management settings and workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_problem_mngmnt/problem_category_6_1.mdx', createDocContent(
    'Problem Category',
    'Admin - Problem Management',
    'Define problem categories for classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_problem_mngmnt/problem_closure_code_6_1.mdx', createDocContent(
    'Problem Closure Code',
    'Admin - Problem Management',
    'Configure closure codes for resolved problems.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_problem_mngmnt/problem_priority_calculator_6_1.mdx', createDocContent(
    'Problem Priority Calculator',
    'Admin - Problem Management',
    'Configure automatic priority calculation for problems.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_problem_mngmnt/problem_states_substates_6_1.mdx', createDocContent(
    'Problem States & Substates',
    'Admin - Problem Management',
    'Define problem states and substates for workflow management.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_problem_mngmnt/problem_timescale_6_1.mdx', createDocContent(
    'Problem Timescale',
    'Admin - Problem Management',
...
function registerAdminReleaseManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/about_release_mngmnt_6_1.mdx', createDocContent(
    'About Release Management Admin',
    'Admin - Release Management',
    'Configure release management settings and workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/release_category_6_1.mdx', createDocContent(
    'Release Category',
    'Admin - Release Management',
    'Define release categories for classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/release_closure_code_6_1.mdx', createDocContent(
    'Release Closure Code',
    'Admin - Release Management',
    'Configure closure codes for completed releases.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/release_priority_calculator_6_1.mdx', createDocContent(
    'Release Priority Calculator',
    'Admin - Release Management',
    'Configure automatic priority calculation for releases.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/release_states_substates_6_1.mdx', createDocContent(
    'Release States & Substates',
    'Admin - Release Management',
    'Define release states and substates for workflow management.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/release_timescale_6_1.mdx', createDocContent(
    'Release Timescale',
    'Admin - Release Management',
    'Configure timescale settings for release processes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_release_mngmnt/release_types_6_1.mdx', createDocContent(
    'Release Types',
    'Admin - Release Management',
...
function registerAdminRequestManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_request_mngmnt/about_request_mngmnt_6_1.mdx', createDocContent(
    'About Request Management Admin',
    'Admin - Request Management',
    'Configure service request management settings and workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_request_mngmnt/request_category_6_1.mdx', createDocContent(
    'Request Category',
    'Admin - Request Management',
    'Define request categories for classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_request_mngmnt/request_closure_code_6_1.mdx', createDocContent(
    'Request Closure Code',
    'Admin - Request Management',
    'Configure closure codes for fulfilled requests.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_request_mngmnt/request_priority_calculator_6_1.mdx', createDocContent(
    'Request Priority Calculator',
    'Admin - Request Management',
    'Configure automatic priority calculation for service requests.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_request_mngmnt/request_states_substates_6_1.mdx', createDocContent(
    'Request States & Substates',
    'Admin - Request Management',
    'Define request states and substates for workflow management.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_request_mngmnt/request_timescale_6_1.mdx', createDocContent(
    'Request Timescale',
    'Admin - Request Management',
...
function registerAdminKnowledgeManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_knowledge_mngmnt/about_knowledge_mngmnt_6_1.mdx', createDocContent(
    'About Knowledge Management Admin',
    'Admin - Knowledge Management',
    'Configure knowledge management settings and workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_knowledge_mngmnt/article_categories_6_1.mdx', createDocContent(
    'Article Categories',
    'Admin - Knowledge Management',
    'Define categories for knowledge base articles.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_knowledge_mngmnt/article_templates_6_1.mdx', createDocContent(
    'Article Templates',
    'Admin - Knowledge Management',
    'Create templates for standardized article creation.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_knowledge_mngmnt/knowledge_approval_workflow_6_1.mdx', createDocContent(
...
function registerAdminServiceCatalogContent() {
  registerContent('/content/6_1/admin_6_1/admin_service_catalog/about_service_catalog_6_1.mdx', createDocContent(
    'About Service Catalog Admin',
    'Admin - Service Catalog',
    'Configure service catalog settings and offerings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_service_catalog/catalog_categories_6_1.mdx', createDocContent(
    'Catalog Categories',
    'Admin - Service Catalog',
    'Define service catalog categories.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_service_catalog/service_offerings_6_1.mdx', createDocContent(
    'Service Offerings',
    'Admin - Service Catalog',
    'Manage available service offerings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_service_catalog/service_request_items_6_1.mdx', createDocContent(
...
function registerAdminContractManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_contract_mngmnt/about_contract_mngmnt_6_1.mdx', createDocContent(
    'About Contract Management Admin',
    'Admin - Contract Management',
    'Configure contract management settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_contract_mngmnt/contract_types_6_1.mdx', createDocContent(
    'Contract Types',
    'Admin - Contract Management',
    'Define different types of contracts.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_contract_mngmnt/contract_states_6_1.mdx', createDocContent(
    'Contract States',
    'Admin - Contract Management',
...
function registerAdminVendorManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_vendor_mngmnt/about_vendor_mngmnt_6_1.mdx', createDocContent(
    'About Vendor Management Admin',
    'Admin - Vendor Management',
    'Configure vendor management settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_vendor_mngmnt/vendor_categories_6_1.mdx', createDocContent(
    'Vendor Categories',
    'Admin - Vendor Management',
    'Define vendor categories and classifications.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_vendor_mngmnt/vendor_rating_system_6_1.mdx', createDocContent(
...
function registerAdminProcurementContent() {
  registerContent('/content/6_1/admin_6_1/admin_procurement/about_procurement_6_1.mdx', createDocContent(
    'About Procurement Admin',
    'Admin - Procurement',
    'Configure procurement process settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_procurement/approval_workflows_6_1.mdx', createDocContent(
    'Approval Workflows',
    'Admin - Procurement',
    'Configure approval workflows for procurement requests.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_procurement/procurement_categories_6_1.mdx', createDocContent(
...
function registerAdminHardwareAssetContent() {
  registerContent('/content/6_1/admin_6_1/admin_hardware_asset_mngmnt/about_hardware_asset_mngmnt_6_1.mdx', createDocContent(
    'About Hardware Asset Management Admin',
    'Admin - Hardware Asset Management',
    'Configure hardware asset management settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_hardware_asset_mngmnt/asset_states_6_1.mdx', createDocContent(
    'Asset States',
    'Admin - Hardware Asset Management',
    'Define hardware asset lifecycle states.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_hardware_asset_mngmnt/asset_categories_6_1.mdx', createDocContent(
    'Asset Categories',
    'Admin - Hardware Asset Management',
...
function registerAdminEventManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_event_mngmnt/about_event_mngmnt_6_1.mdx', createDocContent(
    'About Event Management Admin',
    'Admin - Event Management',
    'Configure event management settings and monitoring.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_event_mngmnt/event_categories_6_1.mdx', createDocContent(
    'Event Categories',
    'Admin - Event Management',
    'Define event categories for classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_event_mngmnt/event_rules_6_1.mdx', createDocContent(
    'Event Rules',
    'Admin - Event Management',
...
function registerAdminProjectManagementContent() {
  registerContent('/content/6_1/admin_6_1/admin_project_mngmnt/about_project_mngmnt_6_1.mdx', createDocContent(
    'About Project Management Admin',
    'Admin - Project Management',
    'Configure project management settings and templates.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_project_mngmnt/project_templates_6_1.mdx', createDocContent(
    'Project Templates',
    'Admin - Project Management',
    'Create and manage project templates.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_project_mngmnt/project_stages_6_1.mdx', createDocContent(
    'Project Stages',
    'Admin - Project Management',
...
function registerAdminSACMContent() {
  registerContent('/content/6_1/admin_6_1/admin_sacm/about_sacm_6_1.mdx', createDocContent(
    'About SACM Admin',
    'Admin - SACM',
    'Configure Service Asset and Configuration Management settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_sacm/ci_types_6_1.mdx', createDocContent(
    'CI Types',
    'Admin - SACM',
    'Define Configuration Item types and attributes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_sacm/relationship_types_6_1.mdx', createDocContent(
    'Relationship Types',
    'Admin - SACM',
...
function registerAdminOtherSubsectionsContent() {
  ...
  registerContent('/content/6_1/admin_6_1/admin/email_notifications_6_1.mdx', createDocContent(
    'Email Notifications',
    'Admin',
    'Configure email notification settings and templates.'
  ));

  registerContent('/content/6_1/admin_6_1/admin/system_preferences_6_1.mdx', createDocContent(
    'System Preferences',
    'Admin',
    'Manage global system preferences and settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin/custom_fields_6_1.mdx', createDocContent(
    'Custom Fields',
    'Admin',
  ...
  // Admin Other
  registerContent('/content/6_1/admin_6_1/admin_other/data_retention_6_1.mdx', createDocContent(
    'Data Retention',
    'Admin',
    'Configure data retention policies and archiving.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_other/backup_restore_6_1.mdx', createDocContent(
    'Backup & Restore',
    'Admin',
