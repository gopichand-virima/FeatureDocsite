...
A [client](/admin_discovery/client_5_13.mdx) needs to be created to associate a client with an Infoblox credential.
...
Select if the scan should be *Immediate* or *Scheduled*. If *Scheduled* is selected, configure the *[Scan Frequency](/discovery/scans_frequency_5_13.mdx)*.
