...
The workflow choices are configured through [Admin > Change Management > Change State Workflow](/admin_change_mngmnt/change_state_workflow_6_1_1.mdx).
...
[Overview of Change Management](/itsm/change_mngmnt/overview_change_mngmnt_6_1_1.mdx)
