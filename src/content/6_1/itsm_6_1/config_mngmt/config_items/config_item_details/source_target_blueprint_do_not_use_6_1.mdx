...
description: >-
  Refer to [CI - Relationships](Config-Items-Relationships.htm) and
  [Blueprints](../../../../Admin%20-%20SACM/Blueprints.htm) for details on using
  this information.
canonical: >-
  https://docs.virima.com/6_1/itsm_6_1/config_mngmt/config_items/config_item_details/source_target_blueprint_do_not_use_6_1
keywords:
...
Refer to [CI - Relationships](Config-Items-Relationships.htm) and [Blueprints](../../../../Admin%20-%20SACM/Blueprints.htm) for details on using this information.
...
### <span class="span_2">Software **Installed On**</span>

| Relationship Type | Target Blueprint                         |
|-------------------|------------------------------------------|
| **Software**      | Installed On Windows Server/Windows Host |

### <span class="span_2" style="font-weight: bold;">IIS Website</span>
...
### <span class="span_2" style="font-weight: bold;">Website</span>

| Relationship Type | Target Blueprint                   |
|-------------------|------------------------------------|
| **Website**       | Hosted On-Any CI having Website IP |

### <span class="span_2">**Apache web-server**, **Tomcat Server**, **application CI** and **MySQL server**</span>
...
### <span class="span_2">MSSQL Cluster</span>
...
### <span class="span_2">Oracle SQL Cluster</span>
