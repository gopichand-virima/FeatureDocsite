...
![Registration](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_1.png)
...
![Create an account](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_2.png)
...
![Verify your email](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_3.png)
...
![Verification successfull](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_4.png)
...
![Sign in](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_5.png)

2.  On the sign in page, enter your **Email** address and click **Continue**.
    

![sign in email](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_6.png)

3.  Enter the Password, and then Click **Login**.
    

![Login](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_7.png)
...
![Auth0 (OIDC)](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_8.png).png)
...
![Forgot password](/assets/images/NG/getting_started_ng/Authentcation/User Authentication_9.png)
