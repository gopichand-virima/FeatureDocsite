...
function registerAdminDiscoveryContent() {
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/downloading_discovery_6_1.mdx', createDocContent(
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/agent_adm_policies_6_1.mdx', createDocContent(
    'Agent ADM Policies',
    'Admin - Discovery',
    'Configure Application Dependency Mapping policies for discovery agents.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/agent_adm_probes_6_1.mdx', createDocContent(
    'Agent ADM Probes',
    'Admin - Discovery',
    'Manage ADM probes for agent-based discovery and dependency mapping.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/agent_configuration_6_1.mdx', createDocContent(
    'Agent Configuration',
    'Admin - Discovery',
    'Configure discovery agent settings and parameters.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/agent_install_packages_6_1.mdx', createDocContent(
    'Agent Install Packages',
    'Admin - Discovery',
    'Manage installation packages for discovery agents across different platforms.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/agent_update_repository_6_1.mdx', createDocContent(
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/azure_install_6_1.mdx', createDocContent(
    'Azure Install',
    'Admin - Discovery',
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/client_agents_schedules_6_1.mdx', createDocContent(
    'Client Agents Schedules',
    'Admin - Discovery',
    'Configure schedules for client agent operations and scans.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/client_build_agent_6_1.mdx', createDocContent(
    'Client Build Agent',
    'Admin - Discovery',
    'Build and customize discovery agents for client deployment.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/client_details_6_1.mdx', createDocContent(
    'Client Details',
    'Admin - Discovery',
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/client_edit_6_1.mdx', createDocContent(
    'Edit Client',
    'Admin - Discovery',
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/config_import_files_6_1.mdx', createDocContent(
    'Configure Import Files',
    'Admin - Discovery',
    'Configure file import settings and formats for data ingestion.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/config_scan_profile_6_1.mdx', createDocContent(
    'Configure Scan Profile',
    'Admin - Discovery',
    'Create and manage scan profiles with specific parameters and settings.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/config_services_account_6_1.mdx', createDocContent(
    'Configure Services Account',
    'Admin - Discovery',
    'Set up service accounts for discovery operations and integrations.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/configuring_application_6_1.mdx', createDocContent(
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/credentials_edit_6_1.mdx', createDocContent(
    'Edit Credentials',
    'Admin - Discovery',
    'Edit existing credential entries and update authentication information.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/credentials_new_6_1.mdx', createDocContent(
    'New Credentials',
    'Admin - Discovery',
    'Add new credentials for discovery operations.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/docker_orchestrator_6_1.mdx', createDocContent(
    'Docker Orchestrator',
    'Admin - Discovery',
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/import_data_files_6_1.mdx', createDocContent(
    'Import Data Files',
    'Admin - Discovery',
    'Import data from external files into the Virima platform.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/installation_discovery_6_1.mdx', createDocContent(
    'Installation Discovery',
    'Admin - Discovery',
    'Installation guide for the discovery application.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/installation_linux_6_1.mdx', createDocContent(
    'Installation Linux',
    'Admin - Discovery',
    'Install discovery components on Linux systems.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/installation_mac_6_1.mdx', createDocContent(
    'Installation Mac',
    'Admin - Discovery',
    'Install discovery components on macOS systems.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/installation_uninstall_6_1.mdx', createDocContent(
    'Uninstall',
    'Admin - Discovery',
    'Uninstall discovery components and clean up system resources.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/installation_windows_6_1.mdx', createDocContent(
    'Installation Windows',
    'Admin - Discovery',
    'Install discovery components on Windows systems.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/installing_application_6_1.mdx', createDocContent(
    'Installing Application',
    'Admin - Discovery',
    'Step-by-step guide for installing the discovery application.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/log_files_6_1.mdx', createDocContent(
    'Log Files',
    'Admin - Discovery',
    'Access and analyze discovery operation log files.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/major_software_details_6_1.mdx', createDocContent(
    'Major Software Details',
    'Admin - Discovery',
    'View detailed information about major software definitions.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/major_software_edit_6_1.mdx', createDocContent(
    'Edit Major Software',
    'Admin - Discovery',
    'Edit existing major software definitions.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/major_software_new_6_1.mdx', createDocContent(
    'New Major Software',
    'Admin - Discovery',
    'Add new major software definitions for tracking.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/minor_software_6_1.mdx', createDocContent(
    'Minor Software',
    'Admin - Discovery',
  ...
  registerContent('/content/6_1/admin_6_1/admin_discovery/network_protocols_6_1.mdx', createDocContent(
    'Network Protocols',
    'Admin - Discovery',
    'Configure network protocols used for discovery operations.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/parallel_scan_config_6_1.mdx', createDocContent(
    'Parallel Scan Configuration',
    'Admin - Discovery',
    'Configure parallel scanning for improved performance.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/pattern_mappings_6_1.mdx', createDocContent(
    'Pattern Mappings',
    'Admin - Discovery',
    'Map discovery patterns to specific device types and attributes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/pattern_policies_6_1.mdx', createDocContent(
    'Pattern Policies',
    'Admin - Discovery',
    'Define policies for pattern-based discovery and classification.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/patterns_6_1.mdx', createDocContent(
    'Patterns',
    'Admin - Discovery',
    'Manage discovery patterns for device identification and data extraction.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/probe_workflow_edit_delete_6_1.mdx', createDocContent(
    'Edit/Delete Probe Workflow',
    'Admin - Discovery',
    'Edit or delete existing probe workflows.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/probes_edit_delete_6_1.mdx', createDocContent(
    'Edit/Delete Probes',
    'Admin - Discovery',
    'Edit or delete existing discovery probes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/probes_new_6_1.mdx', createDocContent(
    'New Probe',
    'Admin - Discovery',
    'Create new discovery probes.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/probes_workflows_sensors_6_1.mdx', createDocContent(
    'Probes, Workflows & Sensors',
    'Admin - Discovery',
    'Overview of probes, workflows, and sensors in discovery operations.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/scan_history_6_1.mdx', createDocContent(
    'Scan History',
    'Admin - Discovery',
    'View historical scan data and results.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/scan_profile_6_1.mdx', createDocContent(
    'Scan Profile',
    'Admin - Discovery',
    'Manage scan profiles for different discovery scenarios.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/scan_workflow_6_1.mdx', createDocContent(
    'Scan Workflow',
    'Admin - Discovery',
    'Configure workflows for automated scan operations.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/sensors_edit_delete_6_1.mdx', createDocContent(
    'Edit/Delete Sensors',
    'Admin - Discovery',
    'Edit or delete existing sensors.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/snmp_device_type_6_1.mdx', createDocContent(
    'SNMP Device Type',
    'Admin - Discovery',
    'Configure SNMP device types and classifications.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/snmp_oid_values_6_1.mdx', createDocContent(
    'SNMP OID Values',
    'Admin - Discovery',
    'Manage SNMP OID values for device discovery and monitoring.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/software_type_6_1.mdx', createDocContent(
    'Software Type',
    'Admin - Discovery',
    'Define and manage software type classifications.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/sql_databases_6_1.mdx', createDocContent(
    'SQL Databases',
    'Admin - Discovery',
    'Discover and manage SQL database instances.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/subnets_6_1.mdx', createDocContent(
    'Subnets',
    'Admin - Discovery',
    'Configure network subnets for discovery scanning.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/system_setting_6_1.mdx', createDocContent(
    'System Settings',
    'Admin - Discovery',
    'Configure system-level settings for discovery operations.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/trusted_certificate_6_1.mdx', createDocContent(
    'Trusted Certificate',
    'Admin - Discovery',
    'Manage trusted certificates for secure communication.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/updating_application_6_1.mdx', createDocContent(
    'Updating Application',
    'Admin - Discovery',
    'Update the discovery application to the latest version.'
  ));

  registerContent('/content/6_1/admin_6_1/admin_discovery/web_services_6_1.mdx', createDocContent(
    'Web Services',
    'Admin - Discovery',
...
function registerAdminOtherContent() {
  // Admin - About
  registerContent('/content/6_1/admin_6_1/about_admin_6_1.mdx', createDocContent(
    'About Admin',
    'Admin',
...
function registerDiscoveryContent() {
  registerContent('/content/6_1/discovery_6_1/about_discovery_scan_6_1.mdx', createDocContent(
    'About Discovery Scan',
    'Discovery',
    'Overview of discovery scanning capabilities and features.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_attachments_6_1.mdx', createDocContent(
    'AD User Import Attachments',
    'Discovery',
    'View attachments related to Active Directory user imports.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_comments_6_1.mdx', createDocContent(
    'AD User Import Comments',
    'Discovery',
    'Manage comments for Active Directory user import operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_details_6_1.mdx', createDocContent(
    'AD User Import Details',
    'Discovery',
    'View detailed information about AD user import operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_edit_6_1.mdx', createDocContent(
    'Edit AD User Import',
    'Discovery',
    'Edit Active Directory user import configurations.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_logs_6_1.mdx', createDocContent(
    'AD User Import Logs',
    'Discovery',
    'View logs for Active Directory user import operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_scan_6_1.mdx', createDocContent(
    'AD User Import Scan',
    'Discovery',
    'Initiate and manage Active Directory user import scans.'
  ));

  registerContent('/content/6_1/discovery_6_1/ad_user_import_tasks_6_1.mdx', createDocContent(
    'AD User Import Tasks',
    'Discovery',
    'Manage tasks related to Active Directory user imports.'
  ));

  registerContent('/content/6_1/discovery_6_1/attachments_6_1.mdx', createDocContent(
    'Attachments',
    'Discovery',
    'Manage attachments for discovery items.'
  ));

  registerContent('/content/6_1/discovery_6_1/azure_ad_user_import_logs_6_1.mdx', createDocContent(
    'Azure AD User Import Logs',
    'Discovery',
    'View logs for Azure Active Directory user import operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/comments_6_1.mdx', createDocContent(
    'Comments',
    'Discovery',
    'Add and manage comments on discovery items.'
  ));

  registerContent('/content/6_1/discovery_6_1/dashboard_discovery_scan_old_6_1.mdx', createDocContent(
    'Discovery Scan Dashboard (Legacy)',
    'Discovery',
    'Legacy dashboard view for discovery scan operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_6_1.mdx', createDocContent(
    'Discovered Items',
    'Discovery',
    'View and manage all discovered items from scans.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_attachments_6_1.mdx', createDocContent(
    'Discovered Items Attachments',
    'Discovery',
    'Manage attachments for discovered items.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_comments_6_1.mdx', createDocContent(
    'Discovered Items Comments',
    'Discovery',
    'Add comments to discovered items.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_components_6_1.mdx', createDocContent(
    'Discovered Items Components',
    'Discovery',
    'View components associated with discovered items.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_details_6_1.mdx', createDocContent(
    'Discovered Items Details',
    'Discovery',
    'View detailed information about discovered items.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_edit_6_1.mdx', createDocContent(
    'Edit Discovered Items',
    'Discovery',
    'Edit discovered item information and properties.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_tasks_6_1.mdx', createDocContent(
    'Discovered Items Tasks',
    'Discovery',
    'Manage tasks related to discovered items.'
  ));

  registerContent('/content/6_1/discovery_6_1/discovered_items_updates_6_1.mdx', createDocContent(
    'Discovered Items Updates',
    'Discovery',
    'View update history for discovered items.'
  ));

  registerContent('/content/6_1/discovery_6_1/downlods_logs_6_1.mdx', createDocContent(
    'Download Logs',
    'Discovery',
    'Access and download discovery operation logs.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_aws_6_1.mdx', createDocContent(
    'Import from AWS',
    'Discovery',
    'Import cloud resources from Amazon Web Services.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_aws_edit_6_1.mdx', createDocContent(
    'Edit AWS Import',
    'Discovery',
    'Edit AWS import configuration settings.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_aws_record_6_1.mdx', createDocContent(
    'AWS Import Record',
    'Discovery',
    'View AWS import operation records and history.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_azure_6_1.mdx', createDocContent(
    'Import from Azure',
    'Discovery',
    'Import cloud resources from Microsoft Azure.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_azure_edit_6_1.mdx', createDocContent(
    'Edit Azure Import',
    'Discovery',
    'Edit Azure import configuration settings.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_cis_6_1.mdx', createDocContent(
    'Import CIS',
    'Discovery',
    'Import Configuration Items from external sources.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_data_file_6_1.mdx', createDocContent(
    'Import Data File',
    'Discovery',
    'Import discovery data from external files.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_data_file_asset_ci_relations_6_1.mdx', createDocContent(
    'Import Data File Asset CI Relations',
    'Discovery',
    'Import asset and CI relationships from data files.'
  ));

  registerContent('/content/6_1/discovery_6_1/import_meraki_6_1.mdx', createDocContent(
    'Import from Meraki',
    'Discovery',
    'Import network devices and data from Cisco Meraki.'
  ));

  registerContent('/content/6_1/discovery_6_1/imported_assets_6_1.mdx', createDocContent(
    'Imported Assets',
    'Discovery',
    'View and manage all imported assets.'
  ));

  registerContent('/content/6_1/discovery_6_1/ipam_networks_6_1.mdx', createDocContent(
    'IPAM Networks',
    'Discovery',
    'Manage IP Address Management networks.'
  ));

  registerContent('/content/6_1/discovery_6_1/ldap_user_import_scans_6_1.mdx', createDocContent(
    'LDAP User Import Scans',
    'Discovery',
    'Execute and manage LDAP user import scan operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/move_cmdb_6_1.mdx', createDocContent(
    'Move to CMDB',
    'Discovery',
    'Transfer discovered items to the CMDB.'
  ));

  registerContent('/content/6_1/discovery_6_1/move_servicenow_6_1.mdx', createDocContent(
    'Move to ServiceNow',
    'Discovery',
    'Export discovered items to ServiceNow.'
  ));

  registerContent('/content/6_1/discovery_6_1/probe_types_6_1.mdx', createDocContent(
    'Probe Types',
    'Discovery',
    'Overview of available discovery probe types.'
  ));

  registerContent('/content/6_1/discovery_6_1/rescan_now_6_1.mdx', createDocContent(
    'Rescan Now',
    'Discovery',
    'Immediately trigger a rescan of selected items.'
  ));

  registerContent('/content/6_1/discovery_6_1/scans_background_info_6_1.mdx', createDocContent(
    'Scans Background Info',
    'Discovery',
    'Background information about scan operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/scans_frequency_6_1.mdx', createDocContent(
    'Scan Frequency',
    'Discovery',
    'Configure scan frequency and timing settings.'
  ));

  registerContent('/content/6_1/discovery_6_1/scans_scheduled_6_1.mdx', createDocContent(
    'Scheduled Scans',
    'Discovery',
    'View and manage scheduled discovery scans.'
  ));

  registerContent('/content/6_1/discovery_6_1/scans_scheduled_edit_6_1.mdx', createDocContent(
    'Edit Scheduled Scan',
    'Discovery',
    'Edit existing scheduled scan configurations.'
  ));

  registerContent('/content/6_1/discovery_6_1/scans_scheduled_new_6_1.mdx', createDocContent(
    'New Scheduled Scan',
    'Discovery',
    'Create new scheduled scan operations.'
  ));

  registerContent('/content/6_1/discovery_6_1/unauthorized_assets_6_1.mdx', createDocContent(
    'Unauthorized Assets',
    'Discovery',
...
function registerCMDBContent() {
  registerContent('/content/6_1/cmdb_6_1/access_cmdb_6_1.mdx', createDocContent(
    'Access CMDB',
    'CMDB',
    'Learn how to access and navigate the Configuration Management Database.'
  ));

  registerContent('/content/6_1/cmdb_6_1/attachments_6_1.mdx', createDocContent(
    'Attachments',
    'CMDB',
    'Manage file attachments for Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/audits_6_1.mdx', createDocContent(
    'Audits',
    'CMDB',
    'Track and review audit history for Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/audits_tab_6_1.mdx', createDocContent(
    'Audits Tab',
    'CMDB',
    'View audit information in the dedicated audits tab.'
  ));

  registerContent('/content/6_1/cmdb_6_1/business_service_map_6_1.mdx', createDocContent(
    'Business Service Map',
    'CMDB',
    'Visualize business services and their CI dependencies.'
  ));

  registerContent('/content/6_1/cmdb_6_1/change_attributes_6_1.mdx', createDocContent(
    'Change Attributes',
    'CMDB',
    'Modify attributes and properties of Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/ci_details_and_tabs_6_1.mdx', createDocContent(
    'CI Details and Tabs',
    'CMDB',
    'Navigate through CI detail tabs and information panels.'
  ));

  registerContent('/content/6_1/cmdb_6_1/ci_left_panel_6_1.mdx', createDocContent(
    'CI Left Panel',
    'CMDB',
    'Use the left navigation panel for CI management.'
  ));

  registerContent('/content/6_1/cmdb_6_1/cmdb_overview_6_1.mdx', createDocContent(
    'CMDB Overview',
    'CMDB',
    'Overview of the Configuration Management Database functionality.'
  ));

  registerContent('/content/6_1/cmdb_6_1/comments_6_1.mdx', createDocContent(
    'Comments',
    'CMDB',
    'Add and manage comments on Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/components_6_1.mdx', createDocContent(
    'Components',
    'CMDB',
    'View and manage CI components and sub-components.'
  ));

  registerContent('/content/6_1/cmdb_6_1/contacts_on_a_ci_6_1.mdx', createDocContent(
    'Contacts on a CI',
    'CMDB',
    'Manage contact information associated with CIs.'
  ));

  registerContent('/content/6_1/cmdb_6_1/copy_to_ivanti_6_1.mdx', createDocContent(
    'Copy to Ivanti',
    'CMDB',
    'Export Configuration Items to Ivanti ITSM platform.'
  ));

  registerContent('/content/6_1/cmdb_6_1/copy_to_jira_6_1.mdx', createDocContent(
    'Copy to Jira',
    'CMDB',
    'Export Configuration Items to Jira Service Management.'
  ));

  registerContent('/content/6_1/cmdb_6_1/copy_to_servicenow_6_1.mdx', createDocContent(
    'Copy to ServiceNow',
    'CMDB',
    'Export Configuration Items to ServiceNow CMDB.'
  ));

  registerContent('/content/6_1/cmdb_6_1/delete_6_1.mdx', createDocContent(
    'Delete CI',
    'CMDB',
    'Delete Configuration Items from the CMDB.'
  ));

  registerContent('/content/6_1/cmdb_6_1/details_6_1.mdx', createDocContent(
    'Details',
    'CMDB',
    'View detailed information about Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/export_6_1.mdx', createDocContent(
    'Export',
    'CMDB',
    'Export CMDB data to various file formats.'
  ));

  registerContent('/content/6_1/cmdb_6_1/generate_installed_software_report_6_1.mdx', createDocContent(
    'Generate Installed Software Report',
    'CMDB',
    'Generate comprehensive reports of installed software across CIs.'
  ));

  registerContent('/content/6_1/cmdb_6_1/history_6_1.mdx', createDocContent(
    'History',
    'CMDB',
    'View change history and audit trail for Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/itsm_6_1.mdx', createDocContent(
    'ITSM Integration',
    'CMDB',
    'Integration points between CMDB and ITSM modules.'
  ));

  registerContent('/content/6_1/cmdb_6_1/logon_events_6_1.mdx', createDocContent(
    'Logon Events',
    'CMDB',
    'Track user logon events for CI assets.'
  ));

  registerContent('/content/6_1/cmdb_6_1/maintenance_6_1.mdx', createDocContent(
    'Maintenance',
    'CMDB',
    'Schedule and track maintenance activities for CIs.'
  ));

  registerContent('/content/6_1/cmdb_6_1/manage_ci_6_1.mdx', createDocContent(
    'Manage CI',
    'CMDB',
    'Comprehensive CI management functions.'
  ));

  registerContent('/content/6_1/cmdb_6_1/manage_cmdb_6_1.mdx', createDocContent(
    'Manage CMDB',
    'CMDB',
    'Overall CMDB management and administration.'
  ));

  registerContent('/content/6_1/cmdb_6_1/new_6_1.mdx', createDocContent(
    'New CI',
    'CMDB',
    'Create new Configuration Items in the CMDB.'
  ));

  registerContent('/content/6_1/cmdb_6_1/other_functions_and_page_elements_6_1.mdx', createDocContent(
    'Other Functions and Page Elements',
    'CMDB',
    'Additional CMDB interface functions and features.'
  ));

  registerContent('/content/6_1/cmdb_6_1/private_properties_6_1.mdx', createDocContent(
    'Private Properties',
    'CMDB',
    'Manage private and custom properties for CIs.'
  ));

  registerContent('/content/6_1/cmdb_6_1/proces_network_virtualization_hierarchy_6_1.mdx', createDocContent(
    'Process Network Virtualization Hierarchy',
    'CMDB',
    'Build virtualization hierarchy for network components.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_adm_6_1.mdx', createDocContent(
    'Process ADM',
    'CMDB',
    'Process Application Dependency Mapping data.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_available_patch_report_6_1.mdx', createDocContent(
    'Process Available Patch Report',
    'CMDB',
    'Generate reports for available patches across CIs.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_cloud_hierarchy_6_1.mdx', createDocContent(
    'Process Cloud Hierarchy',
    'CMDB',
    'Build and manage cloud resource hierarchies.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_devops_6_1.mdx', createDocContent(
    'Process DevOps',
    'CMDB',
    'Integrate DevOps tool data into the CMDB.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_missing_components_6_1.mdx', createDocContent(
    'Process Missing Components',
    'CMDB',
    'Identify and report missing CI components.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_network_connection_6_1.mdx', createDocContent(
    'Process Network Connection',
    'CMDB',
    'Map and process network connections between CIs.'
  ));

  registerContent('/content/6_1/cmdb_6_1/process_software_installation_6_1.mdx', createDocContent(
    'Process Software Installation',
    'CMDB',
    'Track software installation across Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/relationships_6_1.mdx', createDocContent(
    'Relationships',
    'CMDB',
    'Define and manage relationships between Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/sla_6_1.mdx', createDocContent(
    'SLA',
    'CMDB',
    'Associate Service Level Agreements with Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/tasks_6_1.mdx', createDocContent(
    'Tasks',
    'CMDB',
    'Manage tasks related to Configuration Items.'
  ));

  registerContent('/content/6_1/cmdb_6_1/view_and_edit_a_ci_6_1.mdx', createDocContent(
    'View and Edit a CI',
    'CMDB',
    'View and modify Configuration Item details.'
  ));

  registerContent('/content/6_1/cmdb_6_1/vulnerability_6_1.mdx', createDocContent(
    'Vulnerability',
    'CMDB',
...
function registerITAMContent() {
  registerContent('/content/6_1/itam_6_1/about_itam_6_1.mdx', createDocContent(
    'About ITAM',
    'ITAM',
    'Overview of IT Asset Management capabilities in Virima.'
  ));

  registerContent('/content/6_1/itam_6_1/about_itam_newui_6_1.mdx', createDocContent(
    'About ITAM (New UI)',
    'ITAM',
    'Introduction to the new ITAM user interface.'
  ));

  registerContent('/content/6_1/itam_6_1/about_itam_oldui_6_1.mdx', createDocContent(
    'About ITAM (Old UI)',
    'ITAM',
    'Legacy ITAM user interface documentation.'
  ));

  registerContent('/content/6_1/itam_6_1/asset_lic_entitlement_6_1.mdx', createDocContent(
    'Asset License Entitlement',
    'ITAM',
    'Manage software license entitlements for assets.'
  ));

  registerContent('/content/6_1/itam_6_1/asset_lic_entitlement_edit_6_1.mdx', createDocContent(
    'Edit Asset License Entitlement',
    'ITAM',
    'Modify existing license entitlement records.'
  ));

  registerContent('/content/6_1/itam_6_1/asset_lic_entitlement_new_6_1.mdx', createDocContent(
    'New Asset License Entitlement',
    'ITAM',
    'Create new license entitlement records.'
  ));

  registerContent('/content/6_1/itam_6_1/audits_itam_6_1.mdx', createDocContent(
    'ITAM Audits',
    'ITAM',
    'Conduct and manage IT asset audits.'
  ));

  registerContent('/content/6_1/itam_6_1/contract_mngmnt_6_1.mdx', createDocContent(
    'Contract Management',
    'ITAM',
    'Manage contracts related to IT assets and services.'
  ));

  registerContent('/content/6_1/itam_6_1/contract_mngmnt_edit_6_1.mdx', createDocContent(
    'Edit Contract',
    'ITAM',
    'Edit existing contract information.'
  ));

  registerContent('/content/6_1/itam_6_1/contract_mngmnt_new_6_1.mdx', createDocContent(
    'New Contract',
    'ITAM',
    'Create new contract records.'
  ));

  registerContent('/content/6_1/itam_6_1/financial_mngmnt_content_hold_6_1.mdx', createDocContent(
    'Financial Management',
    'ITAM',
    'Manage financial aspects of IT assets.'
  ));

  registerContent('/content/6_1/itam_6_1/hw_asset_6_1.mdx', createDocContent(
    'Hardware Assets',
    'ITAM',
    'Manage hardware asset inventory and lifecycle.'
  ));

  registerContent('/content/6_1/itam_6_1/hw_asset_edit_6_1.mdx', createDocContent(
    'Edit Hardware Asset',
    'ITAM',
    'Modify hardware asset information.'
  ));

  registerContent('/content/6_1/itam_6_1/hw_asset_new_6_1.mdx', createDocContent(
    'New Hardware Asset',
    'ITAM',
    'Add new hardware assets to inventory.'
  ));

  registerContent('/content/6_1/itam_6_1/service_design_package_6_1.mdx', createDocContent(
    'Service Design Package',
    'ITAM',
    'Manage service design packages for IT services.'
  ));

  registerContent('/content/6_1/itam_6_1/service_financial_plan_6_1.mdx', createDocContent(
    'Service Financial Plan',
    'ITAM',
    'Create and manage financial plans for IT services.'
  ));

  registerContent('/content/6_1/itam_6_1/stockroom_6_1.mdx', createDocContent(
    'Stockroom',
    'ITAM',
    'Manage IT asset stockrooms and inventory locations.'
  ));

  registerContent('/content/6_1/itam_6_1/stockroom_edit_6_1.mdx', createDocContent(
    'Edit Stockroom',
    'ITAM',
    'Modify stockroom information and settings.'
  ));

  registerContent('/content/6_1/itam_6_1/stockroom_new_6_1.mdx', createDocContent(
    'New Stockroom',
    'ITAM',
    'Create new stockroom locations.'
  ));

  registerContent('/content/6_1/itam_6_1/stockroom_type_6_1.mdx', createDocContent(
    'Stockroom Type',
    'ITAM',
    'Define and manage stockroom types.'
  ));

  registerContent('/content/6_1/itam_6_1/stockroom_type_edit_6_1.mdx', createDocContent(
    'Edit Stockroom Type',
    'ITAM',
    'Modify stockroom type definitions.'
  ));

  registerContent('/content/6_1/itam_6_1/stockroom_type_new_6_1.mdx', createDocContent(
    'New Stockroom Type',
    'ITAM',
    'Create new stockroom type categories.'
  ));

  registerContent('/content/6_1/itam_6_1/user_entitle_6_1.mdx', createDocContent(
    'User Entitlement',
    'ITAM',
    'Manage user entitlements for software and services.'
  ));

  registerContent('/content/6_1/itam_6_1/user_entitle_edit_6_1.mdx', createDocContent(
    'Edit User Entitlement',
    'ITAM',
    'Modify user entitlement records.'
  ));

  registerContent('/content/6_1/itam_6_1/user_entitle_new_6_1.mdx', createDocContent(
    'New User Entitlement',
    'ITAM',
    'Create new user entitlement records.'
  ));

  registerContent('/content/6_1/itam_6_1/user_license_entitle_6_1.mdx', createDocContent(
    'User License Entitlement',
    'ITAM',
    'Manage license entitlements assigned to users.'
  ));

  registerContent('/content/6_1/itam_6_1/vendor_mngmnt_6_1.mdx', createDocContent(
    'Vendor Management',
    'ITAM',
    'Manage vendor information and relationships.'
  ));

  registerContent('/content/6_1/itam_6_1/vendor_mngmnt_edit_6_1.mdx', createDocContent(
    'Edit Vendor',
    'ITAM',
    'Modify vendor information.'
  ));

  registerContent('/content/6_1/itam_6_1/vendor_mngmnt_new_6_1.mdx', createDocContent(
    'New Vendor',
    'ITAM',
...
function registerITSMContent() {
  registerContent('/content/6_1/itsm_6_1/about_itsm_6_1.mdx', createDocContent(
    'About ITSM',
    'ITSM',
