...
description: "The Process Software Installation action identifies and updates software installation details for selected Configuration Items (CIs)."
version: ""
module: "CMDB"
section: "Process Software Installation"
page: "Process Software Installation"
breadcrumbs:
  - "Home"
  - ""
  - "CMDB"
...
1. The system collects installed software data for the selected CIs.

2. It records application names, versions, vendors, and other related details.

3. Updated software installation data is stored in the CMDB.

4. Review the information in the CI details or relevant CMDB reports.
