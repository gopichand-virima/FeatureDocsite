...
| [Admin](/admin/admin_functions_v5_6_1.mdx) | Users with the admin role in Virima has permission to perform all the functions. |

| [Article Helpful Threshold](/admin_knowledge_mngmnt/article_helpful_threshold_6_1.mdx) | Tracks the knowledge articles that are not helpful and creates anRFC, when the article helpful threshold is met. |
