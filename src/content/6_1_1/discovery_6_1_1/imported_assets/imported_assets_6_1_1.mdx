...
From the *Select Actions* drop-down list, choose either [Move to CMDB](/discovery/move_cmdb_6_1_1_1.mdx) or [Re-Scan](/discovery/discovered_items/re_scan_6_1_1_1.mdx).
