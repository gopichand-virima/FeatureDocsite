...
description: >-
  - In our application, the term client specifically refers to the Discovery
  Application.
canonical: >-
  https://docs.virima.com/6_1/discovery_scan_6_1/discovery/run_a_scan/client_configuration_6_1
keywords:
  - Configuring Client
  - Configuring
  - Client
...
<span class="image placeholder" original-image-src="../../Resources/Images/Discovery/Run-a-Scan/Initiating%20and%20Configuring_28.png" original-image-title=""></span>
