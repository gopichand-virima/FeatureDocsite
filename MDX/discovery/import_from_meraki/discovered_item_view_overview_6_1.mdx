...
- **Blueprint** – The discovery blueprint that matched the resource (e.g., Meraki Virtual Network, Meraki Neo4j). It indicates the CI’s class/type.
...
- **Authorization status** – A badge indicating **Authorized** or **This CI is unauthorized**:
  - Authorized = the CI is recognized/approved to exist in the CMDB; surfaced from Authorize tab of Import from Meraki import records view.
