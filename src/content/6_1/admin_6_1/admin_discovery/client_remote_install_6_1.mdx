...
description: "Use this function to install an agent remotely on a client. To determine if an agent already exists on a client, check the agents tab of the Host Name or IP&#160;Address of the host are present."
version: ""
module: "Admin Discovery"
section: "Client Remote Install"
page: "Remote Install"
breadcrumbs:
  - "Home"
  - ""
