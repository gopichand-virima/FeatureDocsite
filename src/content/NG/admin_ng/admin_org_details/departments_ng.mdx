...
- From the *Select Actions* drop-down list, choose an action: **New Department**, [Delete](/common_topics/delete_remove_ng.mdx) or [Export](/discovery/import_data_files/export_ng.mdx). The New Departments window displays.
...
Refer to [Members](/admin_org_details/departments_members_ng.mdx).
