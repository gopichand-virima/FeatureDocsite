...
You must configure the [Report Properties and Conditions](/reports/reports_props_conds_6_1.mdx) before this step in the report generation process.


The Run Reports tab provides a variety of options, including the following:

- Generating or re-generating
- [Exporting](/discovery/import_data_files/export_6_1.mdx)
- Publishing
- Save as Canned
- Save as Image
- View Data
...
- Enter and save the [Report Properties](/reports/reports_props_conds_6_1.mdx). The window refreshes, and the **Details** and **Run** report tabs display.
...
- *Cannot* be generated, an information message displays. Click the **Details** tab and modify the [Report Properties](/reports/reports_props_conds_6_1.mdx) parameters.
...
- [Resource Chart](/admin_users/users_6_1.mdx#ResourceChart)
...
- [About Ad Hoc Reports](/reports/reports_ad_hoc_6_1.mdx)
