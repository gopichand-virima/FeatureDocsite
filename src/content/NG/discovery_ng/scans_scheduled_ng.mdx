...
| Probe | The required probe. Refer to [Probe Types](/discovery/probe_types_ng.mdx). |
...
| Scheduled | Select if the scan should run at a set interval. *Refer to* [Scan Frequency](/discovery/scans_frequency_ng.mdx)*.* |
