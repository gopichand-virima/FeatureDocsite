...
Refer to [CI - Relationships](/itsm/config_mngmt/config_items/config_item_details/config_items_relationships_6_1_1_1.mdx) and [Blueprints](/admin_sacm/blueprints_6_1_1_1.mdx) for details on using this information.
