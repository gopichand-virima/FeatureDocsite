...
description: "The Process Cloud Hierarchy action builds and updates the hierarchical view of cloud resources for selected Configuration Items (CIs)."
version: ""
module: "CMDB"
section: "Process Cloud Hierarchy"
page: "Process Cloud Hierarchy"
breadcrumbs:
  - "Home"
  - ""
  - "CMDB"
