...
You must configure the [Report Properties and Conditions](/reports/reports_props_conds_5_13.mdx) before this step in the report generation process.


The Run Reports tab provides a variety of options, including the following:

- Generating or re-generating
- [Exporting](/discovery/import_data_files/export_5_13.mdx)
- Publishing
- Save as Canned
- Save as Image
- View Data
...
Enter and save the [Report Properties](/reports/reports_props_conds_5_13.mdx). The window refreshes, and the **Details** and **Run** report tabs display.
...
- *Cannot* be generated, an information message displays. Click the **Details** tab and modify the [Report Properties](/reports/reports_props_conds_5_13.mdx) parameters.
...
- [Resource Chart](/admin_users/users_5_13.mdx#ResourceChart)


- [About Reports](/reports/reports_5_13.mdx)
- [About Canned Reports](/reports/reports_canned_5_13.mdx)
- [About Ad Hoc Reports](/reports/reports_ad_hoc_5_13.mdx)
