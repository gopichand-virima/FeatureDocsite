...
description: "In Import from AWS, open the All tab and click any row (e.g., an Asset Name)."
version: ""
module: "Discovery"
section: "Import From Aws"
page: "Viewing a discovered AWS record"
breadcrumbs:
  - "Home"
  - ""
  - "Discovery"
  - "Import From Aws"
  - "View Discovered Aws Record"
...
- **Authorization status** – A badge indicating **Authorized** or **This CI is unauthorized**:
  - Authorized = the CI is recognized/approved to exist in the CMDB;surfaced from Authorize tab of Import from AWS import records view.
...
- **Tags**– If any  
  Tags are AWS metadata key-value pairs attached to resources (like EC2 instances, S3 buckets, etc.).
