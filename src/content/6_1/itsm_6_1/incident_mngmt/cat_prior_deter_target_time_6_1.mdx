...
description: >-
  To adequately determine if SLAs are met, it is necessary to categorize and
  prioritize incidents quickly and correctly.
canonical: >-
  https://docs.virima.com/6_1/itsm_6_1/incident_mngmt/cat_prior_deter_target_time_6_1
keywords:
