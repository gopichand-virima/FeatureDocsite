...
| Input Value | Impact is determined by how many personnel or functions are affected.
...
- [Categorization, Priority Determination and Target Times](/itsm/incident_mngmt/cat_prior_deter_target_time_ng.mdx)
- [Dashboard](/dashboards/dashboard_overview_ng.mdx)
- [Incident Policy](/itsm/incident_mngmt/incident_policy_ng.mdx)
- [Incidents](/itsm/incident_mngmt/incidents_ng.mdx)
- [Process Flow](/itsm/incident_mngmt/process_flow_ng.mdx)
