...
import { communityPostIds } from '../content/community_forum/index';
import { kbArticleIds } from '../content/kb_articles/index';
import { supportArticleIds } from '../content/support_articles/index';
...
export async function loadCommunityPost(postId: string): Promise<CommunityPost | null> {
  try {
    ...
    const rawContent = getRegisteredContent(`/content/community_forum/${postId}.mdx`);
