...
- [Adding a New Property](/admin_sacm/add_new_property_5_13.mdx)
- Adding a [new CI component](/itsm/config_mngmt/conf_items/config_items_new_5_13.mdx), for example, a Software Instance, Network Adapter, etc.
