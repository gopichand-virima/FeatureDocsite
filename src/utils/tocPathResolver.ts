 ...
 */
function mapModuleIdToTOC(navModuleId: string): string {
  const moduleMap: Record<string, string> = {
    'admin': 'admin',
    'my-dashboard': 'dashboards', // Navigation uses "my-dashboard", TOC uses "dashboards"
...
export async function resolveMDXPathFromTOC({
  ...
  try {
    ...
    // Use the TOC parser to resolve the file path with mapped module ID
