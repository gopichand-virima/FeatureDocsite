...
Perform any of the following installations: [Windows](/admin_discovery/installation_windows_6_1_1.mdx)
...
- [Configuring Services Account](/admin_discovery/config_services_account_6_1_1.mdx)
- [Installing and Running the Windows Application](/admin_discovery/installation_windows_6_1_1.mdx)
- [Uninstalling the Discovery Application](/admin_discovery/installation_uninstall_6_1_1.mdx)
