...
To add a new **Phase**, from the Select Actions drop-down list, choose **Add Phase**. [Refer to Project Template: Phase Information Fields.](/admin_project_mngmnt/project_template_ng.mdx#PhaseInfoFields)

To add a new **Task**, move to a line item containing the applicable phase, and click the **plus + sign**. [Refer to Project Template: Task Information Fields.](/admin_project_mngmnt/project_template_ng.mdx#TaskInfoFields)
...
- The **plus + sign** displays either the [Phase Information](/admin_project_mngmnt/project_template_ng.mdx#PhaseInfoFields) dialog box or the [Task Information](/admin_project_mngmnt/project_template_ng.mdx#TaskInfoFields) dialog box, depending on which type is selected.
