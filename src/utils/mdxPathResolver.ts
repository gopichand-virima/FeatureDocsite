...
function getAdmin61Path(page: string, section: string): string | null {
  ...
  if (folderName) {
    const fileName = `${formatIdToFilename(page)}_6_1.mdx`;
 ...
 */
function getOtherModule61Path(module: string, page: string, section: string): string | null {
 ...
 */
function getCmdb61Path(page: string, section: string): string | null {
  const basePath = '/content/6_1/cmdb_6_1';
  
  // Direct page-to-file mapping for CMDB
  const fileMap: Record<string, string> = {
    'access-cmdb': 'access_cmdb_6_1.mdx',
    'attachments': 'attachments_6_1.mdx',
    'audits': 'audits_6_1.mdx',
    'audits-tab': 'audits_tab_6_1.mdx',
    'business-service-map': 'business_service_map_6_1.mdx',
    'change-attributes': 'change_attributes_6_1.mdx',
    'ci-details-and-tabs': 'ci_details_and_tabs_6_1.mdx',
    'ci-left-panel': 'ci_left_panel_6_1.mdx',
    'cmdb-overview': 'cmdb_overview_6_1.mdx',
    'comments': 'comments_6_1.mdx',
    'components': 'components_6_1.mdx',
    'contacts-on-a-ci': 'contacts_on_a_ci_6_1.mdx',
    'copy-to-ivanti': 'copy_to_ivanti_6_1.mdx',
    'copy-to-jira': 'copy_to_jira_6_1.mdx',
    'copy-to-servicenow': 'copy_to_servicenow_6_1.mdx',
    'delete': 'delete_6_1.mdx',
    'details': 'details_6_1.mdx',
    'export': 'export_6_1.mdx',
    'generate-installed-software-report': 'generate_installed_software_report_6_1.mdx',
    'history': 'history_6_1.mdx',
    'itsm': 'itsm_6_1.mdx',
    'logon-events': 'logon_events_6_1.mdx',
    'maintenance': 'maintenance_6_1.mdx',
    'manage-ci': 'manage_ci_6_1.mdx',
    'manage-cmdb': 'manage_cmdb_6_1.mdx',
    'new': 'new_6_1.mdx',
    'other-functions-and-page-elements': 'other_functions_and_page_elements_6_1.mdx',
    'private-properties': 'private_properties_6_1.mdx',
    'proce-network-virtualization-hierarchy': 'proce_network_virtualization_hierarchy_6_1.mdx',
    'process-adm': 'process_adm_6_1.mdx',
    'process-available-patch-report': 'process_available_patch_report_6_1.mdx',
    'process-cloud-hierarchy': 'process_cloud_hierarchy_6_1.mdx',
    'process-devops': 'process_devops_6_1.mdx',
    'process-missing-components': 'process_missing_components_6_1.mdx',
    'process-network-connection': 'process_network_connection_6_1.mdx',
    'process-software-installation': 'process_software_installation_6_1.mdx',
    'relationships': 'relationships_6_1.mdx',
    'sla': 'sla_6_1.mdx',
    'tasks': 'tasks_6_1.mdx',
    'view-and-edit-a-ci': 'view_and_edit_a_ci_6_1.mdx',
    'vulnerability': 'vulnerability_6_1.mdx',
  };
