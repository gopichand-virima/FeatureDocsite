...
const trendingThreads: ForumThread[] = [
  {
    ...
    avatar: "SM",
    content:
      "We're excited to announce Virima 6.2 with significant performance improvements, enhanced CMDB capabilities, and new AI-powered discovery features...",
  ...
  },
  {
    ...
    avatar: "DC",
    content:
      "We're planning to migrate our CMDB from a legacy system to Virima. Looking for recommendations on the best migration strategy...",
    timestamp: "5 hours ago",
    views: 456,
    replies: 12,
    likes: 23,
    status: "open",
    tags: ["migration", "cmdb", "data"],
  },
  {
    id: "3",
    ...
    avatar: "MR",
    content:
      "After working with Virima in enterprise environments, here are proven strategies to optimize discovery scan performance...",
    timestamp: "1 day ago",
    views: 892,
    replies: 28,
    likes: 67,
    status: "solved",
    tags: ["discovery", "performance", "best-practices"],
  },
  {
    id: "4",
    category: "features",
    title: "Feature Request: Advanced ITSM Workflow Automation",
    author: "James Wilson",
    authorRole: "IT Director",
    avatar: "JW",
    content:
      "Would love to see more advanced workflow automation capabilities in ITSM module, similar to enterprise platforms...",
    timestamp: "2 days ago",
    views: 623,
    replies: 45,
    likes: 156,
    status: "trending",
    tags: ["feature-request", "itsm", "automation"],
  },
  {
    id: "5",
    category: "integrations",
    title: "ServiceNow Integration: Complete Setup Guide",
    author: "Emily Thompson",
    authorRole: "Integration Specialist",
    avatar: "ET",
    content:
      "Step-by-step guide for setting up bidirectional sync between Virima and ServiceNow CMDB...",
    timestamp: "3 days ago",
    views: 1034,
    replies: 19,
    likes: 94,
    status: "solved",
    tags: ["integration", "servicenow", "guide"],
  },
  {
    id: "6",
    category: "security",
    title: "Vulnerability Management Dashboard Best Practices",
    author: "Robert Kumar",
    authorRole: "Security Analyst",
    avatar: "RK",
    content:
      "Sharing our team's approach to configuring vulnerability management dashboards for executive reporting...",
    timestamp: "4 days ago",
    views: 567,
    replies: 15,
    likes: 42,
    status: "open",
    tags: ["security", "vulnerability", "dashboard"],
  },
  {
    id: "7",
    category: "technical",
    title: "CMDB Relationship Mapping - Need help with complex dependencies",
    author: "Lisa Anderson",
    authorRole: "Configuration Manager",
    avatar: "LA",
    content:
      "Working on mapping complex application dependencies in our CMDB. Any tips on best practices for relationship types?",
    timestamp: "5 days ago",
    views: 389,
    replies: 22,
    likes: 31,
    status: "solved",
    tags: ["cmdb", "relationships", "configuration"],
  },
  {
    id: "8",
    category: "training",
    title: "Virima Certification Program - Study Resources Thread",
    author: "Michael Brown",
    authorRole: "Training Coordinator",
    avatar: "MB",
    content:
      "Let's compile a list of helpful resources for those preparing for Virima certification exams...",
    timestamp: "1 week ago",
    views: 1156,
    replies: 67,
    likes: 128,
    status: "trending",
    tags: ["certification", "training", "resources"],
  },
];
