...
description: "Use these cards to record who owns and supports the CI. Each card shows a profile avatar, Name, Email, and Phone.Common controls:"
version: ""
module: "Cmdb Left Nav"
section: "Contacts On A Ci"
page: "Contacts on a CI"
breadcrumbs:
  - "Home"
  - ""
  - "Cmdb Left Nav"
