...
description: >-
  Request management (or request fulfillment) focuses on fulfilling Service
  Requests, which are often minor (standard) changes (e.g., upgrade RAM for
  physical machine) or requests for information (e.g., requests to change a
  password).
canonical: >-
  https://docs.virima.com/6_1/itsm_6_1/request_fulfillment/about_request_fulfillment_6_1
keywords:
