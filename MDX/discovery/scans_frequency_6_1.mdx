...
- Manage any [Tasks](/itsm/release_mngmt/tasks_6_1.mdx), [Comments](/discovery/comments_6_1.mdx), or [Attachments](/discovery/attachments_6_1.mdx).
...
| Scan Frequency | The time interval at which the scan runs. When a predefined time is selected from the drop-down list, the timetable columns update accordingly. For example, if the **Scan Frequency** is every **3 days**, the selections and shading in the table automatically adjust. ![scan frequency example 574x250](../Resources/Images/Discovery/scan-frequency-example_574x250.png) ![scan frequency new 394x311](../Resources/Images/Discovery/scan-frequency-new_394x311.png) |
