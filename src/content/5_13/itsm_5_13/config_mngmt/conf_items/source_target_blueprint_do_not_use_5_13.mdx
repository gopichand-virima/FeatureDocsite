...
Refer to [CI - Relationships](/itsm/config_mngmt/config_items/config_item_details/config_items_relationships_5_13.mdx) and [Blueprints](/admin_sacm/blueprints_5_13.mdx) for details on using this information.
