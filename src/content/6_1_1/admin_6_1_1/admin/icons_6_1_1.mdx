...
| ![icon v6 update scan](
        ...
        $fileReplacements++
        return "$prefix$newPath$newExt"
    ) | Launches the Update Scheduled Scan dialog box in which details for the currently selected scan record can be modified. *Refer to* [Scan Frequency](/discovery/scans_frequency_6_1_1_1.mdx)*.* |
