...
| Probe | The required probe. Refer to [Probe Types](/discovery/probe_types_6_1_1.mdx). |
...
| Scheduled | Select if the scan should run at a set interval. *Refer to* [Scan Frequency](/discovery/scans_frequency_6_1_1.mdx)*.* |


- [Recent Scans](/discovery/recent_scans/scans_recent_6_1_1.mdx)
- [Scheduled Scans](/discovery/scans_scheduled_6_1_1.mdx)
- [Scan Frequency](/discovery/scans_frequency_6_1_1.mdx)
- [Background Scan Information](/discovery/scans_background_info_6_1_1.mdx)
- [Probe Types](/discovery/probe_types_6_1_1.mdx)
