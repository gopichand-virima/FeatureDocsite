---
title: Apply and Save a Filter
description: '1. Under the column header, click in the **Filter** field.'
canonical: 'https://docs.virima.com/6_1/common_topics/saved_filters_6_1'
keywords:
