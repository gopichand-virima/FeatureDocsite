...
The workflow choices are configured through [Admin > Change Management > Change State Workflow](/admin_change_mngmnt/change_state_workflow_5_13.mdx).
...
[Overview of Change Management](/itsm/change_mngmnt/overview_change_mngmnt_5_13.mdx)
