---
title: "Audits"
description: "The Audits tab in the CMDB allows users to define and manage audit schedules for Configuration Items (CIs). Audits ensure the integrity and accuracy of CI data through periodic checks."
version: ""
