...
canonical: >-
  https://docs.virima.com/6_1/discovery_scan_6_1/discovery/run_a_scan/configure_discovery_scan_6_1
keywords:
...
<span class="image placeholder" original-image-src="../../Resources/Images/Discovery/Run-a-Scan/Initiating%20and%20Configuring_2.png" original-image-title=""></span>
...
<span class="image placeholder" original-image-src="../../Resources/Images/Discovery/Run-a-Scan/Initiating%20and%20Configuring_3.png" original-image-title=""></span>
...
- Scheduled Scan Details
  ...
  - If scheduled, set:
    ...
    - Schedule: Second, Minute, Hour, Day, Month, Weekday  
      <span class="Emphasis">(Choose either Day or Weekday, not both)</span>

    - Active: Enable/disable the schedule.

    - Recurring: Enable for repeated scans (yearly)

<span class="image placeholder" original-image-src="../../Resources/Images/Discovery/Run-a-Scan/Initiating%20and%20Configuring_4.png" original-image-title=""></span>
...
<span class="image placeholder" original-image-src="../../Resources/Images/Discovery/Run-a-Scan/Initiating%20and%20Configuring_5.png" original-image-title=""></span>
...
<span class="image placeholder" original-image-src="../../Resources/Images/Discovery/Run-a-Scan/Initiating%20and%20Configuring_6.png" original-image-title=""></span>
