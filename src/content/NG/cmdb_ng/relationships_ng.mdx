---
title: "Relationships"
description: "The Relationships tab in the CMDB allows users to view, manage, and establish connections between a selected Configuration Item (CI) and other assets."
version: ""
module: "CMDB"
