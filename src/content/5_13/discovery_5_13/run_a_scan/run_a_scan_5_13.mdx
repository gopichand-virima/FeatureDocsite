...
| Probe | The required probe. Refer to [Probe Types](/discovery/probe_types_5_13.mdx). |
...
| Scheduled | Select if the scan should run at a set interval. *Refer to* [Scan Frequency](/discovery/scans_frequency_5_13.mdx)*.* |


- [Recent Scans](/discovery/recent_scans/scans_recent_5_13.mdx)
- [Scheduled Scans](/discovery/scans_scheduled_5_13.mdx)
- [Scan Frequency](/discovery/scans_frequency_5_13.mdx)
- [Background Scan Information](/discovery/scans_background_info_5_13.mdx)
- [Probe Types](/discovery/probe_types_5_13.mdx)
