...
[Open topic with navigation](/admin_vendor_mngmnt/vendor_property_group_6_1.mdx)

# Vendor Property Group

Use this function to create a vendor property group to select when setting up a [vendor property](/admin_vendor_mngmnt/vendor_properties_6_1.mdx).
