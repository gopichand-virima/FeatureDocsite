...
description: "The Change Attributes action in the Virima CMDB enables users to update one or more field values across selected Configuration Items (CIs) in bulk."
version: ""
module: "Cmdb Left Nav"
section: "Change Attributes"
page: "Change attributes"
breadcrumbs:
  - "Home"
  - ""
  - "Cmdb Left Nav"
