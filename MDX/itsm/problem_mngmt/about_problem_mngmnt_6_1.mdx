...
Custom Timescale. Defines define the Response time and the Resolution time for a specific problem model /Problem. If custom timescale is not set, the system uses default timescales as defined in [Problem Timescales](/admin_problem_mngmnt/problem_timescale_6_1.mdx).
