...
description: "The Process Available Patch Report action generates a report of all available software patches applicable to the selected Configuration Items (CIs)."
version: ""
module: "CMDB"
section: "Process Available Patch Report"
page: "Process Available Patch Report"
breadcrumbs:
  - "Home"
  - ""
  - "CMDB"
