...
Perform any of the following installations: [Windows](/admin_discovery/installation_windows_5_13.mdx)
...
- [Configuring Services Account](/admin_discovery/config_services_account_5_13.mdx)
- [Installing and Running the Windows Application](/admin_discovery/installation_windows_5_13.mdx)
- [Uninstalling the Discovery Application](/admin_discovery/installation_uninstall_5_13.mdx)
