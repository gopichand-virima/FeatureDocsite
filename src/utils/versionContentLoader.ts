...
import { versionToPath } from './tocLoader';
 ...
 * Uses TOC-driven approach for versions with index.mdx
 */
...
function constructDirectPath(
  ...
  // Try common patterns
  const patterns = [
    `${config.contentBasePath}/${versionPath}/${moduleId}/${sectionId}/${pageId}.mdx`,
    `${config.contentBasePath}/${versionPath}/${moduleId}/${pageId}.mdx`,
    `${config.contentBasePath}/${moduleId}/${sectionId}/${pageId}-${versionPath}.mdx`,
    `${config.contentBasePath}/${moduleId}/${sectionId}/${pageId}.mdx`,
  ];
