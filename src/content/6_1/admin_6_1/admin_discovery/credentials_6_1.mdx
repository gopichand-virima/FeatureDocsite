---
title: "Credentials"
description: "Use this function to enable the definition of authentication of the Server or other network components that helps to confirm their identity in a monitored network environment."
version: ""
...
Refer to [Credential Details](/admin_discovery/credentials_details_6_1.mdx) for information on additional options.
