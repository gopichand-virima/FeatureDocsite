...
- **[ADM View](/itsm/config_mngmt/config_items/config_item_details/bsm_examples/bsm_adm_view_6_1_1.mdx)** displays the graphical connection between the applications or between applications and configuration items based on the relationship *Communicates With*.
...
- **[Communication View](/itsm/config_mngmt/config_items/config_item_details/bsm_examples/bsm_comm_view_6_1_1.mdx)** displays the graphical connection between the configuration items based on the relationship *Communicates With*.
- **Infrastructure View** displays the end-to-end visualization of a Server/Application infrastructure.
- **[Network View](/itsm/config_mngmt/config_items/config_item_details/bsm_examples/bsm_network_view_6_1_1.mdx)** displays the physical and non-physical connections among the assets and/or business services based on relationships.
