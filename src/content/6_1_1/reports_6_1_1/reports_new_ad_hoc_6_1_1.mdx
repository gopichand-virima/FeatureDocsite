...
Use this function to create view and modify Ad Hoc reports and save [Canned Reports](/reports/reports_canned_6_1_1.mdx).

There are three steps in the process:

Step 1. Specify the **Identifying Information** such as visibility and frequency. *See below*.

Step 2. Select the **Report Properties** and set the **Conditions**. *Refer to* [Report Properties and Conditions](/reports/reports_props_conds_6_1_1.mdx)*.*

Step 3. **Run** (or Generate) the report. *Refer to* [Run Report](/reports/reports_run_6_1_1.mdx)*.*
...
![send report to dialog box](../Resources/Images/Reports/send-report-to-dialog-box.PNG)
...
![schedule report frequency](../Resources/Images/Reports/schedule-report-frequency.PNG) |
...
To continue the process, follow the instructions for [Report Properties and Conditions](/reports/reports_props_conds_6_1_1.mdx).
