...
description: >-
  Problem Management is the process responsible for managing the lifecycle of
  all problems. The primary objectives of Problem Management are to:
canonical: 'https://docs.virima.com/6_1/itsm_6_1/problem_mngmt/about_problem_mngmnt_6_1'
keywords:
